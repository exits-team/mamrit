<?php $page_title = 'About - Mamrit Farms'; ?>
<?php include('includes/main_header.php'); ?>

<section class="sub-header shop-layout-1">
  <img class="rellax bg-overlay" src="images/file-20170928-1488-1e5vdjp.jpg" alt="">
  <div class="overlay-call-to-action"></div>
  <h3 class="heading-style-3" style="background: rgba(255, 255, 255, 0.7);padding: 0 10px;">About Us</h3>
</section>
  ...
  <div class="container">
    <div class="row blog-v reverse">
      <div class="col-md-12">
        <div class="post">
          <div class="img-wrapper js-set-bg-blog-thumb">
            <img src="images/about.jpg" alt="blog-thumb">
          </div>
          <div class="desc">
            <h3 class="title-about">Who We Are</h3>
            <p class="sapo">Myself Mr. Vikas Dixit, working as research Scientist in Pharma R&D (Research & Development) During my 17 years career in different types of Organic & Inorganic Chemicals. Finally, i realize that instead of curing the various types of human body diseases, it is better to maintain healthy life style by consuming natural Organic Food and light exercises.</p>
            <p class="sapo">We as a Indian are graced with 5000 years legacy of Desi Cow Milk Which is Enrich source of protein, calcium, Vitamins, and Minerals.</p>
            <p class="sapo">From 2019, We have started a desi Cow Farms with scientific approach like balance diet (Maize, Lentil, Wheat, Cotton seed Cake, Azolla) and natural mineral mixture to improve/fulfil milk quality.
            </p>
          </div>
        </div>
      </div>
      <!--             <div class="col-md-12">
              <div class="post">
                <div class="img-wrapper js-set-bg-blog-thumb">
                  <img src="images/1522875600_2531546971_1940856806.jpg" alt="blog-thumb">
                </div>
                <div class="desc">
                  <h3 class="title-about">What We Do</h3>
                  <p class="sapo para-1">We provide all kinds of organic products. Produced on our farm, the products are always fresh, multi-vitamins, rich variety for your family.</p>
                  <p class="sapo">Vestibulum eu nisl vitae torto feugiat aliquet finibus in libero. Vivamus et enim accumsan, tempus dui non, pretium libero. Vivamus vitae justo non metus malesuada finibus. Pellentesque vehicula porttitor eleifend. Proin eget velit
